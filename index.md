    ...
    <section id="portfolio" class="p-0">
        <div class="container-fluid p-0">
            <div class="row no-gutters popup-gallery">
                <div class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/1.jpg"><img class="img-fluid" src="assets/img/thumbnails/colaboremos.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Workshops</span></div><div class="project-name"><span>Gracias al programa me anime a realizar distintas actividades como Workshops</span></div></div></div></a></div>
                <div
                    class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/2.jpg"><img class="img-fluid" src="assets/img/thumbnails/curso.png"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>courses</span></div><div class="project-name"><span>La semana pasada imparti mi primer curso de programación 😄</span></div></div></div></a></div>
            <div
                class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/3.jpg"><img class="img-fluid" src="assets/img/thumbnails/miyagi.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>da todo de ti</span></div><div class="project-name"><span>La Sherpa Fer siempre nos recuerda algo que quedara marcado en mi para siempre "Siempre den lo mejor de ustedes"</span></div></div></div></a></div>
        <div
            class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/4.jpg"><img class="img-fluid" src="assets/img/thumbnails/guild.png"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Guild</span></div><div class="project-name"><span>Forme una guild junto a mis compañeros para empoderar a estudiantes a conocer todas las cosas que podemos hacer con la tecnología que existe hoy dia</span></div></div></div></a></div>
            <div
                class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/5.jpg"><img class="img-fluid" src="assets/img/thumbnails/mac.png"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Student dev pack</span></div><div class="project-name"><span>Conoci como puedo utilizar las herramientas del SDP para crear cosas asombrosas, como esta pagina 😋</span></div></div></div></a></div>
                <div
                    class="col-sm-6 col-lg-4"><a class="portfolio-box" href="assets/img/fullsize/6.jpg"><img class="img-fluid" src="assets/img/thumbnails/hack.jpg"><div class="portfolio-box-caption"><div class="portfolio-box-caption-content"><div class="project-category text-faded"><span>Hacktoberfest</span></div><div class="project-name"><span>Este año complete mi primer Hacktoberfest 🤩</span></div></div></div></a></div>
                    </div>
                    </div>
    </section>
    <!-- Start: Team Clean -->
    <div class="team-clean">
        <div class="container">
            ...
            <div class="row people">
                <div class="col-md-6 col-lg-4 item"><img class="rounded-circle" src="assets/img/rodo.png">
                    <h3 class="name">Rodolfo Ferro</h3>
                    <p class="title">desarrollador</p>
                    <p class="description">Una de las personas más buena onda que he conocido en este programa. Realiza comentarios que son importantes pero que me sacan una buena risa 🤣<br>Definitivamente un modelo a seguir</p>
                    <div class="social"><a href="https://github.com/RodolfoFerro/"><i class="fa fa-github" data-bs-hover-animate="rubberBand"></i></a><a href="https://twitter.com/FerroRodolfo/"><i class="fa fa-twitter" data-bs-hover-animate="rubberBand"></i></a><a data-bs-hover-animate="rubberBand"
